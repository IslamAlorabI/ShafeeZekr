...
data class AppSettings(
    ...
    val muteOnSilent: Boolean = false,
    val muteOnDND: Boolean = false,
    val muteOnMedia: Boolean = false,
...
class PreferencesManager(private val context: Context) {
    ...
    val settingsFlow: Flow<AppSettings> = context.dataStore.data.map { preferences ->
        AppSettings(
            ...
            muteOnCall = preferences[PreferencesKeys.MUTE_ON_CALL] ?: false,
            muteOnSilent = preferences[PreferencesKeys.MUTE_ON_SILENT] ?: false,
            muteOnDND = preferences[PreferencesKeys.MUTE_ON_DND] ?: false,
            muteOnMedia = preferences[PreferencesKeys.MUTE_ON_MEDIA] ?: false,
